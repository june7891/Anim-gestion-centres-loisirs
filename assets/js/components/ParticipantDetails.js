...
const ParticipantDetails = () => {
  ...
  useEffect(() => {
    axios.get(`/api/participants/${id}`).then((response) => {
            ...
            <div className="col-lg-4 text-center">
              <div className="card details-card mb-4">
                <div className="participant-card-body card-body text-center">
                  <div className="profile-image-container">
                    {participant.image && (
                      <img
                        src={require(`../../../public/images/uploads/participants_files/${participant.image}`)}
                  ...
                  <p className="text-muted mb-1">
                    Classe: {participant.schoolLevel?.level}
                  </p>
                  <p className="text-muted mb-4">
                    Ecole: {participant?.schoolName}
                  </p>
                </div>
              </div>
              {user[0] === "ROLE_USER" ? (
                ...
                <div className="profile-btn-container mb-4">
                  <a
                    ...
                    href={`/participant-modification-form/${participant.id}`}
                  >
                    Modifier la fiche de renseignement
                  </a>

                  <button className="modification-btn" onClick={handleShowEmail}>
              ...
              >
                <Modal.Header closeButton>
                  <Modal.Title>
                    {" "}
                    <h3>Contacter la famille</h3>{" "}
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                  {" "}
                  <EmailModal
                    parentOne={parentOne.email}
                    parentTwo={parentTwo.email}
                  />{" "}
                </Modal.Body>
              </Modal>
            </div>
              ...
              <div className="card mb-4 participant-detail-card-body">
                <div className="card-body participant-detail-card-body">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-9">
                      <p className="text-muted mb-0">
                        {participant.address}, {participant.postalCode}{" "}
                        {participant.city}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-9">
                      {activities?.length == 0 ? (
                        <p className="text-muted mb-0">Aucune activité</p>
                      ) : (
                        activities?.map((activity) => (
                          <p key={activity.id} className="text-muted mb-0">
                  ...
                  {user[0] === "ROLE_USER" ? (
                    ...
                    <div className="row-9">
                      ...
                      >
                        ...
                        {participant.image && (
                          <a
                            href={require(`../../../public/images/uploads/participants_files/${participant.image}`)}
                            download
                          >
                        ...
                        {participant.ficheSanitaire && (
                          <a
                            href={require(`../../../public/images/uploads/participants_files/${participant.ficheSanitaire}`)}
                            download
                          >
                            Fiche sanitaire
                          </a>
                        ...
                        {participant.vaccination && (
                          <a
                            href={require(`../../../public/images/uploads/participants_files/${participant.vaccination}`)}
                            download
                          >
                            Vaccins
                          </a>
                        ...
                        <input
                          ...
                          accept="image/png, image/jpeg"
                          onChange={(e) =>
                            formik.setFieldValue("insurance", e.target.files[0])
                          }
                        />

                        {participant.insurance && (
                          <a
                            href={require(`../../../public/images/uploads/participants_files/${participant.insurance}`)}
                            download
                          >
                            Assurance
                          </a>

...
const ParticipantModificationForm = () => {
  ...
  useEffect(() => {
    const getParticipant = async () => {
      await axios.get(`/api/participants/${id}`).then((response) => {
            ...
            <div className="col-lg-4 text-center">
              ...
              <div className="profile-btn-container mb-4">
                <a
                  ...
                  href={`/participant-details/${participant.id}`}
                >

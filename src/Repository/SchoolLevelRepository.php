...
/**
 * @extends ServiceEntityRepository<SchoolLevel>
 *
...
class SchoolLevelRepository extends ServiceEntityRepository
{
    ...
    public function add(SchoolLevel $entity, bool $flush = false): void
    {
    ...
    public function remove(SchoolLevel $entity, bool $flush = false): void
    {
